...
def save_class_activation_on_image(org_img, activation_map, file_name):
    ...
    # resized activation map
    activation_heatmap_resized = cv2.resize(activation_heatmap, (org_img.shape[1], org_img.shape[0]))

    # Heatmap on picture
    #org_img = cv2.resize(org_img, (224, 224))
    img_with_heatmap = np.float32(activation_heatmap_resized) + np.float32(org_img)
